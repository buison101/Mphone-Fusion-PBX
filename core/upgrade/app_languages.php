...
$text['login-message_text']['en-us'] = "Keep up with the Mphone project by configuring your preferences in the newly added <a href=''/core/notifications/notification_edit.php''>Notifications</a> section, under the System menu!";
$text['login-message_text']['vi-vn'] = "Theo dõi dự án Mphone bằng cách cấu hình tùy chọn của bạn trong mục <a href=''/core/notifications/notification_edit.php''>Thông báo</a> mới được thêm dưới menu Hệ thống!";
$text['login-message_text']['en-gb'] = "Keep up with the Mphone project by configuring your preferences in the newly added <a href=''/core/notifications/notification_edit.php''>Notifications</a> section, under the System menu!";
$text['login-message_text']['ar-eg'] = "حافظ على مشروع (فيوس بي إكس) من خلال تشكيل أفضلياتك في القسم المضاف حديثاً";
$text['login-message_text']['de-at'] = "Halten Sie sich über Mphone auf dem Laufenden indem Sie die Benachrichtigungseinstellungen im System Menü setzen.";
$text['login-message_text']['de-ch'] = "Halten Sie sich über Mphone auf dem Laufenden indem Sie die Benachrichtigungseinstellungen im System Menü setzen.";
$text['login-message_text']['de-de'] = "Halten Sie sich über Mphone auf dem Laufenden indem Sie die Benachrichtigungseinstellungen im System Menü setzen.";
$text['login-message_text']['el-gr'] = "Συνεχίστε με το έργο Mphone διαμορφώνοντας τις προτιμήσεις σας στην ενότητα <a href=''/core/notifications/notification_edit.php''>Ειδοποιήσεις</a> που προστέθηκε πρόσφατα, κάτω από το μενού Σύστημα!";
$text['login-message_text']['es-cl'] = "Manténgase al día con el proyecto Mphone configurando sus preferencias en la sección <a href=''/core/notifications/notification_edit.php''>Notificaciones</a> acaba de agregar, en el menú del sistema!";
$text['login-message_text']['es-mx'] = "Manténgase al día con el proyecto Mphone configurando sus preferencias en la sección <a href=''/core/notifications/notification_edit.php''>Notificaciones</a> acaba de agregar, en el menú del sistema!";
$text['login-message_text']['fr-ca'] = "Tenez-vous au courant des nouveautés du projet Mphone en configurant vos préférences dans la section <a href=''/core/notifications/notification_edit.php''>Notifications</a> , du menu système!";
$text['login-message_text']['fr-fr'] = "Tenez-vous au courant des nouveautés du projet Mphone en configurant vos préférences dans la section <a href=''/core/notifications/notification_edit.php''>Notifications</a> , du menu système!";
$text['login-message_text']['he-il'] = "שמור על הפרויקט Mphone על ידי הצבת ההעדפות שלך ב- <a href='/core/notifications/notifications_edit.php'>Notifications</a>, תחת תפריט המערכת!";
$text['login-message_text']['it-it'] = "Tieniti aggiornato sul progetto Mphone configurando le tue preference nella nuova sezione <a href=''/core/notifications/notification_edit.php''>Notifiche</a>, sotto il menu sistema!";
$text['login-message_text']['ka-ge'] = "მისდიეთ Mphone პროექტს თქვენი პარამეტრების დამატებით ახლად დამატებულ <a href=''/core/notifications/notification_edit.php''>გაფრთხილებებში</a> სისტემურ მენიუში.";
$text['login-message_text']['nl-nl'] = "Blijf op de hoogte van het Mphone-project door uw voorkeuren te configureren in de nieuw toegevoegde <a href=''/core/notifications/notification_edit.php''>Meldingen</a> sectie, onder het Systeemmenu!";
$text['login-message_text']['pl-pl'] = "Bądź na bieżąco z projektem Mphone konfigurując swoje preferencje w  nowo dodanej sekcji Powiadomienia w menu System!";
$text['login-message_text']['pt-br'] = "Mantenha-se com o projeto Mphone configurando suas preferências na seção <a href=''/core/notifications/notification_edit.php''>Notificações</a> recém-adicionado, no menu Sistema!";
$text['login-message_text']['pt-pt'] = "Mantenha-se com o projeto Mphone configurando suas preferências na seção <a href=''/core/notifications/notification_edit.php''>Notificações</a> recém-adicionado, no menu Sistema!";
$text['login-message_text']['ro-ro'] = "Fii la curent cu proiectul Mphone configurându-ți preferințele în secțiunea nou adăugată <a href=''/core/notifications/notification_edit.php''>Notificări</a>, din meniul Sistem!";
$text['login-message_text']['ru-ru'] = "Следите за проектом Mphone, настроив свои настройки в недавно добавленном разделе <a href=''/core/notifications/notification_edit.php''>Уведомления</a> в меню 'Система'!";
$text['login-message_text']['sv-se'] = "Håll dig uppdaterad med de Mphone projektet genom att konfigurera dina inställningar i nytillkomna Notifications avsnitt , under Systemmenyn !";
$text['login-message_text']['uk-ua'] = "Будьте в курсі проекту Mphone, налаштовуючи свої налаштування в нещодавно доданому <a href='/core/notifications/notification_edit.php'> сповіщення </a> Розділ, в меню системи!";
$text['login-message_text']['tr-tr'] = "Sistem menüsü altına yeni eklenen <a href=''/core/notifications/notification_edit.php''>Bildirimler</a> bölümündeki tercihlerinizi yapılandırarak Mphone projesini takip edin!";
$text['login-message_text']['zh-cn'] = "跟上Mphone项目，通过在系统菜单下的新添加的<a href=''/core/notification/notification_edit.php''> notifications中配置您的首选项</notification/notification_edit.php''> notifications </a>部分！";
$text['login-message_text']['ja-jp'] = '新しく追加された <a href=""/core/notifications/notifications_edit.php">Notifications</a> セクションで設定することで Mphone プロジェクトを続けてください。';
...
$text['description-upgrade_source']['en-us'] = "Updates Mphone source files from the repository.";
$text['description-upgrade_source']['vi-vn'] = "Cập nhật file nguồn Mphone từ repository.";
$text['description-upgrade_source']['en-gb'] = "Updates Mphone source files from the repository.";
$text['description-upgrade_source']['ar-eg'] = "يقوم بتحديث ملفات مصدر Mphone من المستودع.";
$text['description-upgrade_source']['de-at'] = "Aktualisiert den Mphone Quellcode aus dem Repository";
$text['description-upgrade_source']['de-ch'] = "Aktualisiert den Mphone Quellcode aus dem Repository";
$text['description-upgrade_source']['de-de'] = "Aktualisiert den Mphone Quellcode aus dem Repository";
$text['description-upgrade_source']['el-gr'] = "Ενημερώνει τα αρχεία πηγής Mphone από το αποθετήριο.";
$text['description-upgrade_source']['es-cl'] = "Archivos de origen Actualizaciones Mphone del repositorio.";
$text['description-upgrade_source']['es-mx'] = "Archivos de origen Actualizaciones Mphone del repositorio.";
$text['description-upgrade_source']['fr-ca'] = "Mise à jour du code source de Mphone depuis le dépôt.";
$text['description-upgrade_source']['fr-fr'] = "Mise à jour du code source de Mphone depuis le dépôt.";
$text['description-upgrade_source']['he-il'] = "עדכון קובצי המקור של Mphone מ-Respository.";
$text['description-upgrade_source']['it-it'] = "Aggiorna il files sorgente di Mphone dal repository.";
$text['description-upgrade_source']['ka-ge'] = "განაახლებს Mphone-ის საწყისი კოდის ფაილების რეპოზიტორიიდან.";
$text['description-upgrade_source']['nl-nl'] = "Updates Mphone bron bestanden van het verzet.";
$text['description-upgrade_source']['pl-pl'] = "Uaktualnia pliki źródłowe Mphone z przechowalni.";
$text['description-upgrade_source']['pt-br'] = "Atualiza o Mphone a partir dos arquivos de código fonte do repositório.";
$text['description-upgrade_source']['pt-pt'] = "Arquivos de origem Atualizações Mphone do repositório.";
$text['description-upgrade_source']['ro-ro'] = "Actualizează fișierele sursă Mphone din depozit.";
$text['description-upgrade_source']['ru-ru'] = "Обновляет исходные файлы Mphone из репозитория.";
$text['description-upgrade_source']['sv-se'] = "Uppdaterar Mphone källfiler från respository.";
$text['description-upgrade_source']['uk-ua'] = "Оновлення вихідних файлів  Mphone з репозиторію Subversion .";
$text['description-upgrade_source']['tr-tr'] = "Mphone kaynak dosyalarını depodan günceller.";
$text['description-upgrade_source']['zh-cn'] = "从存储库更新Mphone源文件。";
$text['description-upgrade_source']['ja-jp'] = "Mphoneソースファイルをリポジトリから更新します。";
