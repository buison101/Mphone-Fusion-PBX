...
$text['title-notifications']['vi-vn'] = "Thông báo";
...
$text['option-enabled']['vi-vn'] = "Đã bật";
...
$text['option-disabled']['vi-vn'] = "Đã tắt";
...
$text['message-no_channels']['vi-vn'] = "Chưa bật kênh nào";
...
$text['message-invalid_recipient']['vi-vn'] = "Người nhận thông báo không hợp lệ";
...
$text['message-disclaimer']['en-us'] = "<u>Disclosure</u>: Enabling Project Notifications is consent to the collection of <i>anonymous</i> and <i>general</i> demographic information about your installation environment.  Information requested consists of the following: 1) Mphone version, 2) PHP version, 3) web server and version, 4) voice switch version, 5) database type and version, 6) operating system platform and version, and 7) public IP address. If you do not wish for this information to be submitted, simply leave Project Notifications disabled, and no information will be submitted about your system.";
$text['message-disclaimer']['vi-vn'] = "<u>Công bố</u>: Bật Thông báo dự án đồng nghĩa với việc bạn đồng ý cho thu thập thông tin thống kê <i>ẩn danh</i> và <i>tổng quát</i> về môi trường cài đặt. Thông tin được yêu cầu gồm: 1) phiên bản Mphone, 2) phiên bản PHP, 3) web server và phiên bản, 4) phiên bản voice switch, 5) loại và phiên bản cơ sở dữ liệu, 6) nền tảng và phiên bản hệ điều hành, và 7) địa chỉ IP công cộng. Nếu bạn không muốn gửi thông tin này, chỉ cần để Thông báo dự án ở trạng thái tắt và sẽ không có thông tin nào về hệ thống của bạn được gửi đi.";
...
$text['message-disclaimer']['ro-ro'] = "<u> Dezvăluire </u>: Activarea notificărilor proiectului este consimțământ pentru colectarea <i> Anonim </i> și <i> General </i> informații demografice despre mediul dvs. de instalare. Informațiile solicitate constă din următoarele: 1) Versiunea Mphone, 2) versiunea PHP, 3) serverul și versiunea web, 4) versiunea de comutare vocală, 5) Tip și versiunea bazei de date, 6) Platforma și versiunea sistemului de operare și 7) IP public abordare. Dacă nu doriți ca aceste informații să fie transmise, lăsați pur și simplu dezactivate notificările proiectului și nu vor fi transmise informații despre sistemul dvs.";
$text['message-disclaimer']['ru-ru'] = "<u>Раскрытие информации</u>: включение уведомлений проекта означает согласие на сбор <i>анонимной</i> и <i>общей</i> демографической информации о вашей среде установки. Запрашиваемая информация состоит из следующего: 1) версия Mphone, 2) версия PHP, 3) веб-сервер и версия, 4) версия голосового коммутатора, 5) тип и версия базы данных, 6) платформа и версия операционной системы и 7) общедоступный IP-адрес. адрес. Если вы не хотите, чтобы эта информация отправлялась, просто оставьте уведомления о проектах отключенными, и никакая информация о вашей системе не будет отправлена.";
$text['message-disclaimer']['sv-se'] = "<u>Upplysning</u>: Aktivering av projektmeddelanden är ett samtycke till insamling av <i>anonym</i> och <i>allmän</i> demografisk information om din installationsmiljö. Information som efterfrågas består av följande: 1) Mphone-version, 2) PHP-version, 3) webbserver och version, 4) version av röstväxel, 5) databastyp och version, 6) operativsystemplattform och version, och 7) offentlig IP adress. Om du inte vill att denna information ska skickas lämnar du helt enkelt Project Notifications inaktiverad, så kommer ingen information att skickas om ditt system.";
$text['message-disclaimer']['uk-ua'] = "<u>Розкриття інформації</u>: увімкнення сповіщень проекту означає згоду на збір <i>анонімної</i> та <i>загальної</i> демографічної інформації про ваше середовище встановлення. Запитана інформація складається з наступного: 1) версія Mphone, 2) версія PHP, 3) веб-сервер і версія, 4) версія голосового перемикача, 5) тип і версія бази даних, 6) платформа та версія операційної системи та 7) публічна IP-адреса адресу. Якщо ви не бажаєте, щоб ця інформація надсилалася, просто залиште сповіщення про проект вимкненими, і жодна інформація про вашу систему не надсилатиметься.";
$text['message-disclaimer']['tr-tr'] = "<u>Açıklama</u>: Proje Bildirimlerini etkinleştirmek, kurulum ortamınız hakkında <i>anonim</i> ve <i>genel</i> demografik bilgilerin toplanmasına izin vermek anlamına gelir. Talep edilen bilgiler aşağıdakilerden oluşur: 1) Mphone sürümü, 2) PHP sürümü, 3) web sunucusu ve sürümü, 4) ses anahtarı sürümü, 5) veritabanı türü ve sürümü, 6) işletim sistemi platformu ve sürümü ve 7) genel IP adres. Bu bilgilerin gönderilmesini istemiyorsanız Proje Bildirimlerini devre dışı bırakmanız yeterlidir; sisteminiz hakkında hiçbir bilgi gönderilmez.";
$text['message-disclaimer']['zh-cn'] = "<u>披露</u>：启用项目通知即同意收集关于您的安装环境的<i>匿名</i>和<i>一般</i>人口统计信息。 请求信息包括：1）Mphone版本，2）PHP版本，3）Web服务器及版本，4）语音交换机版本，5）数据库类型及版本，6）操作系统平台及版本，7）公网IP 地址。 如果您不希望提交此信息，只需禁用项目通知，就不会提交有关您系统的任何信息。";
$text['message-disclaimer']['ja-jp'] = "<u>開示</u>: プロジェクト通知を有効にすると、インストール環境に関する<i>匿名</i>および<i>一般</i>の人口統計情報の収集に同意することになります。 要求される情報は次のもので構成されます: 1) Mphone バージョン、2) PHP バージョン、3) Web サーバーとバージョン、4) 音声スイッチのバージョン、5) データベースの種類とバージョン、6) オペレーティング システムのプラットフォームとバージョン、7) パブリック IP 住所。 この情報の送信を希望しない場合は、プロジェクト通知を無効のままにしておくと、システムに関する情報は送信されません。";
$text['message-disclaimer']['ko-kr'] = "<u>공개</u>: 프로젝트 알림을 활성화하면 설치 환경에 대한 <i>익명</i> 및 <i>일반</i> 인구 통계 정보 수집에 동의하는 것입니다. 요청하는 정보는 1) Mphone 버전, 2) PHP 버전, 3) 웹 서버 및 버전, 4) 음성 스위치 버전, 5) 데이터베이스 유형 및 버전, 6) 운영 체제 플랫폼 및 버전, 7) 공인 IP로 구성됩니다. 주소. 이 정보를 제출하지 않으려면 프로젝트 알림을 비활성화된 상태로 두면 시스템에 대한 정보가 제출되지 않습니다.";

$text['message-demographics_submitted']['en-us'] = "Demographics Submitted";
$text['message-demographics_submitted']['vi-vn'] = "Đã gửi thông tin thống kê";
...
$text['message-demographics_click_here']['vi-vn'] = "nhấp vào đây";
...
$text['message-demographics']['en-us'] = "<u>Note</u>: To help the Mphone project by submitting the demographic information described above <i>without</i> subscribing to Project Notifications, simply ";
$text['message-demographics']['vi-vn'] = "<u>Ghi chú</u>: Để hỗ trợ dự án Mphone bằng cách gửi thông tin thống kê mô tả ở trên <i>mà không</i> đăng ký Thông báo dự án, chỉ cần ";
$text['message-demographics']['en-gb'] = "<u>Note</u>: To help the Mphone project by submitting the demographic information described above <i>without</i> subscribing to Project Notifications, simply ";
$text['message-demographics']['ar-eg'] = "<u> ملاحظة </ u>: لمساعدة مشروع Mphone عن طريق إرسال المعلومات الديموغرافية الموضحة أعلاه <i> بدون </ i> الاشتراك في إخطارات المشروع ، ببساطة";
$text['message-demographics']['de-at'] = "<u>Hinweis</u>: Um das Mphone-Projekt zu unterstützen, indem Sie einfach die oben beschriebenen demografischen Informationen einreichen, <i>ohne</i> die Projektbenachrichtigungen zu abonnieren ";
$text['message-demographics']['de-ch'] = "<u>Hinweis</u>: Um das Mphone-Projekt zu unterstützen, indem Sie einfach die oben beschriebenen demografischen Informationen einreichen, <i>ohne</i> die Projektbenachrichtigungen zu abonnieren ";
$text['message-demographics']['de-de'] = "<u>Hinweis</u>: Um das Mphone-Projekt zu unterstützen, indem Sie einfach die oben beschriebenen demografischen Informationen einreichen, <i>ohne</i> die Projektbenachrichtigungen zu abonnieren ";
$text['message-demographics']['el-gr'] = "<u>Σημείωση</u>: Για να βοηθήσετε το έργο Mphone υποβάλλοντας τις δημογραφικές πληροφορίες που περιγράφονται παραπάνω <i>χωρίς</i> να εγγραφείτε στις Ειδοποιήσεις Έργου, απλώς ";
$text['message-demographics']['es-cl'] = "<u>Nota</u>: para ayudar al proyecto Mphone enviando la información demográfica descrita anteriormente <i>sin</i> suscribirse a las notificaciones del proyecto, simplemente ";
$text['message-demographics']['es-mx'] = "<u>Nota</u>: para ayudar al proyecto Mphone enviando la información demográfica descrita anteriormente <i>sin</i> suscribirse a las notificaciones del proyecto, simplemente ";
$text['message-demographics']['fr-ca'] = "<u>Remarque</u>: Pour aider le projet Mphone en soumettant les informations démographiques décrites ci-dessus <i>sans</i> souscrire aux notifications de projet, il vous suffit de ";
$text['message-demographics']['fr-fr'] = "<u>Remarque</u>: Pour aider le projet Mphone en soumettant les informations démographiques décrites ci-dessus <i>sans</i> souscrire aux notifications de projet, il vous suffit de ";
$text['message-demographics']['he-il'] = "<u>הערה</u>: כדי לעזור לפרויקט Mphone על ידי שליחת המידע הדמוגרפי המתואר לעיל <i>ללא</i> להירשם ל-Project Notifications, פשוט";
$text['message-demographics']['it-it'] = "<u>Nota</u>: per aiutare il progetto Mphone inviando le informazioni demografiche sopra descritte <i>senza</i> iscriversi alle notifiche di progetto, è sufficiente";
$text['message-demographics']['ka-ge'] = "<u>შენიშვნა</u>: იმისათვის, რომ დაეხმაროთ Mphone-ის პროექტს დემოგრაფიული ინფორმაციის გადაცემის, რომელიც მაღლაა არწერილი, პროექტი გაფრთხილებების გამოწერის <i>გარეშე</i>";
$text['message-demographics']['nl-nl'] = "<u>Opmerking</u>: om het Mphone-project te helpen door de hierboven beschreven demografische informatie in te dienen <i>zonder</i> u te abonneren op projectmeldingen, hoeft u alleen maar ";
$text['message-demographics']['pl-pl'] = "<u>Uwaga</u>: Aby pomóc projektowi Mphone, przesyłając informacje demograficzne opisane powyżej <i>bez</i> subskrypcji powiadomień o projekcie, po prostu ";
$text['message-demographics']['pt-br'] = "<u>Nota</u>: Para ajudar o projeto Mphone enviando as informações demográficas descritas acima <i>sem</i> assinar as Notificações do Projeto, simplesmente";
$text['message-demographics']['pt-pt'] = "<u>Nota</u>: Para ajudar o projeto Mphone enviando as informações demográficas descritas acima <i>sem</i> assinar as Notificações do Projeto, simplesmente";
$text['message-demographics']['ro-ro'] = "<u> Notă </u>: Pentru a ajuta proiectul Mphone prin trimiterea informațiilor demografice descrise mai sus <i> fără </i> abonarea la notificări ale proiectului, pur și simplu";
$text['message-demographics']['ru-ru'] = "<u>Примечание</u>: чтобы помочь проекту Mphone, отправив демографическую информацию, описанную выше, <i>без</i> подписки на уведомления проекта, просто";
$text['message-demographics']['sv-se'] = "<u>Obs</u>: För att hjälpa Mphone-projektet genom att skicka in den demografiska informationen som beskrivs ovan <i>utan</i> att prenumerera på projektmeddelanden, helt enkelt";
$text['message-demographics']['uk-ua'] = "<u>Примітка</u>: щоб допомогти проекту Mphone, надавши описану вище демографічну інформацію <i>без</i> підписки на сповіщення про проект, просто";
$text['message-demographics']['tr-tr'] = "<u>Not</u>: Yukarıda açıklanan demografik bilgileri Proje Bildirimlerine abone olmadan <i>olmadan</i> göndererek Mphone projesine yardımcı olmak için, yalnızca";
$text['message-demographics']['zh-cn'] = "<u>注意</u>：要通过提交上述人口统计信息来帮助 Mphone 项目<i>而不</i>订阅项目通知，只需";
$text['message-demographics']['ja-jp'] = "<u>注</u>: プロジェクト通知を購読する<i>ことなく</i>、上記の人口統計情報を送信して Mphone プロジェクトを支援するには、単に";
$text['message-demographics']['ko-kr'] = "<u>참고</u>: Project Notifications에 가입하지 <i>않고</i> 위에서 설명한 인구 통계 정보를 제출하여 Mphone 프로젝트를 지원하려면 간단히";

$text['label-project_security']['en-us'] = "Security";
$text['label-project_security']['vi-vn'] = "Bảo mật";
...
$text['label-project_releases']['vi-vn'] = "Bản phát hành";
...
$text['label-project_notifications']['vi-vn'] = "Thông báo dự án";
...
$text['label-project_notification_recipient']['vi-vn'] = "Người nhận";
...
$text['label-project_notification_method']['vi-vn'] = "Phương thức";
...
$text['label-project_news']['vi-vn'] = "Tin tức";
...
$text['label-project_events']['vi-vn'] = "Sự kiện";
...
$text['header-notifications']['vi-vn'] = "Thông báo";
...
$text['description-project_security']['vi-vn'] = "Nhận thông báo về các bản cập nhật bảo mật.";
...
$text['description-project_releases']['en-us'] = "Receive notifications when new stable version of Mphone are released and available for download.";
$text['description-project_releases']['vi-vn'] = "Nhận thông báo khi phiên bản ổn định mới của Mphone được phát hành và có thể tải xuống.";
$text['description-project_releases']['en-gb'] = "Receive notifications when new stable version of Mphone are released and available for download.";
$text['description-project_releases']['ar-eg'] = "احصل على إشعارات عند إصدار إصدار ثابت جديد من Mphone وإتاحته للتنزيل.";
$text['description-project_releases']['de-at'] = "Erhalten Sie Benachrichtigungen, wenn neue stabile Versionen von Mphone veröffentlicht werden und zum Download verfügbar sind.";
$text['description-project_releases']['de-ch'] = "Erhalten Sie Benachrichtigungen, wenn neue stabile Versionen von Mphone veröffentlicht werden und zum Download verfügbar sind.";
$text['description-project_releases']['de-de'] = "Erhalten Sie Benachrichtigungen, wenn neue stabile Versionen von Mphone veröffentlicht werden und zum Download verfügbar sind.";
$text['description-project_releases']['el-gr'] = "Λάβετε ειδοποιήσεις όταν κυκλοφορήσει η νέα σταθερή έκδοση του Mphone και είναι διαθέσιμη για λήψη.";
$text['description-project_releases']['es-cl'] = "Reciba notificaciones cuando se lance una nueva versión estable de Mphone y esté disponible para descargar.";
$text['description-project_releases']['es-mx'] = "Reciba notificaciones cuando se lance una nueva versión estable de Mphone y esté disponible para descargar.";
$text['description-project_releases']['fr-ca'] = "Recevez des notifications lorsqu'une nouvelle version stable de Mphone est publiée et disponible au téléchargement.";
$text['description-project_releases']['fr-fr'] = "Recevez des notifications lorsqu'une nouvelle version stable de Mphone est publiée et disponible au téléchargement.";
$text['description-project_releases']['he-il'] = "קבל התראות כאשר גרסה יציבה חדשה של Mphone יוצאת וזמינה להורדה.";
$text['description-project_releases']['it-it'] = "Ricevi notifiche quando la nuova versione stabile di Mphone viene rilasciata e disponibile per il download.";
$text['description-project_releases']['ka-ge'] = "მიიღეთ გაფრთხილებები, როცა Mphone-ის ახალი ვერსია გამოვა.";
$text['description-project_releases']['nl-nl'] = "Ontvang meldingen wanneer er een nieuwe stabiele versie van Mphone wordt uitgebracht en beschikbaar is om te downloaden.";
$text['description-project_releases']['pl-pl'] = "Otrzymuj powiadomienia, gdy nowa stabilna wersja Mphone zostanie wydana i będzie dostępna do pobrania.";
$text['description-project_releases']['pt-br'] = "Receba notificações quando uma nova versão estável do Mphone for lançada e estiver disponível para download.";
$text['description-project_releases']['pt-pt'] = "Receba notificações quando uma nova versão estável do Mphone for lançada e estiver disponível para download.";
$text['description-project_releases']['ro-ro'] = "Primiți notificări când o nouă versiune stabilă a Mphone este lansată și disponibilă pentru descărcare.";
$text['description-project_releases']['ru-ru'] = "Получайте уведомления, когда новая стабильная версия Mphone выпущена и доступна для загрузки.";
$text['description-project_releases']['sv-se'] = "Få meddelanden när en ny stabil version av Mphone släpps och är tillgänglig för nedladdning.";
$text['description-project_releases']['uk-ua'] = "Отримуйте сповіщення, коли нова стабільна версія Mphone буде випущена та доступна для завантаження.";
$text['description-project_releases']['tr-tr'] = "Mphone'in yeni kararlı sürümü yayınlandığında ve indirilmeye hazır olduğunda bildirim alın.";
$text['description-project_releases']['zh-cn'] = "当 Mphone 的新稳定版本发布并可供下载时接收通知。";
$text['description-project_releases']['ja-jp'] = "Mphone の新しい安定バージョンがリリースされ、ダウンロード可能になったときに通知を受け取ります。";
$text['description-project_releases']['ko-kr'] = "Mphone의 안정적인 새 버전이 출시되어 다운로드할 수 있을 때 알림을 받습니다.";

$text['description-project_notifications']['en-us'] = "Enable Mphone project notifications.";
$text['description-project_notifications']['vi-vn'] = "Bật thông báo dự án Mphone.";
$text['description-project_notifications']['en-gb'] = "Enable Mphone project notifications.";
$text['description-project_notifications']['ar-eg'] = "تفعيل إشعارات مشروع Mphone.";
$text['description-project_notifications']['de-at'] = "Mphone Projekt-Benachrichtigung aktivieren.";
$text['description-project_notifications']['de-ch'] = "Mphone Projekt-Benachrichtigung aktivieren.";
$text['description-project_notifications']['de-de'] = "Mphone Projekt-Benachrichtigung aktivieren.";
$text['description-project_notifications']['el-gr'] = "Ενεργοποίηση ειδοποιήσεων έργου Mphone.";
$text['description-project_notifications']['es-cl'] = "Habilitar las notificaciones de proyectos Mphone.";
$text['description-project_notifications']['es-mx'] = "Habilitar las notificaciones de proyectos Mphone.";
$text['description-project_notifications']['fr-ca'] = "Activer les notifications de projet Mphone.";
$text['description-project_notifications']['fr-fr'] = "Activer les notifications de projet Mphone.";
$text['description-project_notifications']['he-il'] = "אפשר התראות על פרויקט Mphone.";
$text['description-project_notifications']['it-it'] = "Abilita le notifiche di progetto di Mphone.";
$text['description-project_notifications']['ka-ge'] = "Mphone-ის ოექტის გაფრთხილებების ჩართვა.";
$text['description-project_notifications']['nl-nl'] = "Schakel Mphone-projectmeldingen in.";
$text['description-project_notifications']['pl-pl'] = "Włącz powiadomienia o projekcie Mphone.";
$text['description-project_notifications']['pt-br'] = "Ative as notificações do projeto Mphone.";
$text['description-project_notifications']['pt-pt'] = "Ative as notificações do projeto Mphone.";
$text['description-project_notifications']['ro-ro'] = "Activați notificările de proiect Mphone.";
$text['description-project_notifications']['ru-ru'] = "Включить уведомления проекта Mphone.";
$text['description-project_notifications']['sv-se'] = "Aktivera Mphone-projektmeddelanden.";
$text['description-project_notifications']['uk-ua'] = "Увімкнути сповіщення про проект Mphone.";
$text['description-project_notifications']['tr-tr'] = "Mphone proje bildirimlerini etkinleştirin.";
$text['description-project_notifications']['zh-cn'] = "启用 Mphone 项目通知。";
$text['description-project_notifications']['ja-jp'] = "Mphone プロジェクト通知を有効にします。";
$text['description-project_notifications']['ko-kr'] = "Mphone 프로젝트 알림을 활성화합니다.";

$text['description-project_notification_recipient']['en-us'] = "Enter the desired Email Address for the recipient.";
$text['description-project_notification_recipient']['vi-vn'] = "Nhập địa chỉ email mong muốn cho người nhận.";
...
$text['description-project_notification_method']['vi-vn'] = "Chọn phương thức liên lạc mong muốn.";
...
$text['description-project_news']['en-us'] = "Receive notifications of general Mphone related news and information.";
$text['description-project_news']['vi-vn'] = "Nhận thông báo về tin tức và thông tin chung liên quan đến Mphone.";
$text['description-project_news']['en-gb'] = "Receive notifications of general Mphone related news and information.";
$text['description-project_news']['ar-eg'] = "تلقي إخطارات بالأخبار والمعلومات العامة المتعلقة بـ Mphone.";
$text['description-project_news']['de-at'] = "Erhalten Sie Benachrichtigungen über allgemeine Neuigkeiten und Informationen zu Mphone.";
$text['description-project_news']['de-ch'] = "Erhalten Sie Benachrichtigungen über allgemeine Neuigkeiten und Informationen zu Mphone.";
$text['description-project_news']['de-de'] = "Erhalten Sie Benachrichtigungen über allgemeine Neuigkeiten und Informationen zu Mphone.";
$text['description-project_news']['el-gr'] = "Λάβετε ειδοποιήσεις για γενικές ειδήσεις και πληροφορίες που σχετίζονται με το Mphone.";
$text['description-project_news']['es-cl'] = "Reciba notificaciones de noticias e información general relacionada con Mphone.";
$text['description-project_news']['es-mx'] = "Reciba notificaciones de noticias e información general relacionada con Mphone.";
$text['description-project_news']['fr-ca'] = "Recevez des notifications d'actualités et d'informations générales sur Mphone.";
$text['description-project_news']['fr-fr'] = "Recevez des notifications d'actualités et d'informations générales sur Mphone.";
$text['description-project_news']['he-il'] = "קבל הודעות על חדשות ומידע כלליים הקשורים ל-Mphone.";
$text['description-project_news']['it-it'] = "Ricevi notifiche di notizie e informazioni generali relative a Mphone.";
$text['description-project_news']['ka-ge'] = "მიიღეთ გაფრთხილებები Mphone-ის ზოგადი ახალი ამბების და ინფორმაციის შესახებ.";
$text['description-project_news']['nl-nl'] = "Ontvang meldingen van algemeen Mphone-gerelateerd nieuws en informatie.";
$text['description-project_news']['pl-pl'] = "Otrzymuj powiadomienia o ogólnych wiadomościach i informacjach związanych z Mphone.";
$text['description-project_news']['pt-br'] = "Receba notificações de notícias e informações gerais relacionadas ao Mphone.";
$text['description-project_news']['pt-pt'] = "Receba notificações de notícias e informações gerais relacionadas ao Mphone.";
$text['description-project_news']['ro-ro'] = "Primiți notificări cu știri și informații generale legate de Mphone.";
$text['description-project_news']['ru-ru'] = "Получайте уведомления об общих новостях и информации, связанных с Mphone.";
$text['description-project_news']['sv-se'] = "Ta emot meddelanden om allmänna Mphone-relaterade nyheter och information.";
$text['description-project_news']['uk-ua'] = "Отримуйте сповіщення про загальні новини та інформацію щодо Mphone.";
$text['description-project_news']['tr-tr'] = "Mphone ile ilgili genel haber ve bilgilerin bildirimlerini alın.";
$text['description-project_news']['zh-cn'] = "接收一般 Mphone 相关新闻和信息的通知。";
$text['description-project_news']['ja-jp'] = "Mphone 関連の一般的なニュースと情報の通知を受け取ります。";
$text['description-project_news']['ko-kr'] = "일반적인 Mphone 관련 뉴스 및 정보 알림을 받습니다.";

$text['description-project_events']['en-us'] = "Receive notifications of upcoming Mphone training classes, convention booths, and other events related to the project.";
$text['description-project_events']['vi-vn'] = "Nhận thông báo về các lớp đào tạo Mphone sắp tới, gian hàng hội nghị và các sự kiện khác liên quan đến dự án.";
$text['description-project_events']['en-gb'] = "Receive notifications of upcoming Mphone training classes, convention booths, and other events related to the project.";
$text['description-project_events']['ar-eg'] = "تلقي إخطارات عن الدورات التدريبية القادمة Mphone ، وأكشاك المؤتمرات ، والأحداث الأخرى المتعلقة بالمشروع.";
$text['description-project_events']['de-at'] = "Erhalten Sie Benachrichtigungen über bevorstehende Mphone-Schulungen, Kongressstände und andere Veranstaltungen im Zusammenhang mit dem Projekt.";
$text['description-project_events']['de-ch'] = "Erhalten Sie Benachrichtigungen über bevorstehende Mphone-Schulungen, Kongressstände und andere Veranstaltungen im Zusammenhang mit dem Projekt.";
$text['description-project_events']['de-de'] = "Erhalten Sie Benachrichtigungen über bevorstehende Mphone-Schulungen, Kongressstände und andere Veranstaltungen im Zusammenhang mit dem Projekt.";
$text['description-project_events']['el-gr'] = "Λάβετε ειδοποιήσεις για επερχόμενα εκπαιδευτικά μαθήματα Mphone, περίπτερα συνεδρίων και άλλες εκδηλώσεις που σχετίζονται με το έργο.";
$text['description-project_events']['es-cl'] = "Reciba notificaciones de las próximas clases de capacitación, cabinas de convenciones y otros eventos relacionados con el proyecto de Mphone.";
$text['description-project_events']['es-mx'] = "Reciba notificaciones de las próximas clases de capacitación, cabinas de convenciones y otros eventos relacionados con el proyecto de Mphone.";
$text['description-project_events']['fr-ca'] = "Recevez des notifications des prochains cours de formation Mphone, des stands de convention et d'autres événements liés au projet.";
$text['description-project_events']['fr-fr'] = "Recevez des notifications des prochains cours de formation Mphone, des stands de convention et d'autres événements liés au projet.";
$text['description-project_events']['he-il'] = "קבל הודעות על שיעורי הדרכה עתידיים של Mphone, דוכני כנסים ואירועים אחרים הקשורים לפרויקט.";
$text['description-project_events']['it-it'] = "Ricevi notifiche sui prossimi corsi di formazione Mphone, stand congressuali e altri eventi relativi al progetto.";
$text['description-project_events']['ka-ge'] = "ინფორმაციის მიღება მომავალი Mphone-ის ტრენინგის კლასების, ბუტიკების და სხვა მოვლენების შესახებ.";
$text['description-project_events']['nl-nl'] = "Ontvang meldingen van aankomende Mphone-trainingsklassen, congresstands en andere evenementen die verband houden met het project.";
$text['description-project_events']['pl-pl'] = "Otrzymuj powiadomienia o zbliżających się szkoleniach Mphone, stoiskach konferencyjnych i innych wydarzeniach związanych z projektem.";
$text['description-project_events']['pt-br'] = "Receba notificações das próximas aulas de treinamento Mphone, estandes de convenções e outros eventos relacionados ao projeto.";
$text['description-project_events']['pt-pt'] = "Receba notificações das próximas aulas de treinamento Mphone, estandes de convenções e outros eventos relacionados ao projeto.";
$text['description-project_events']['ro-ro'] = "Primiți notificări cu privire la cursurile viitoare de instruire Mphone, cabinele de convenții și alte evenimente legate de proiect.";
$text['description-project_events']['ru-ru'] = "Получайте уведомления о предстоящих учебных курсах Mphone, стендах для конференций и других мероприятиях, связанных с проектом.";
$text['description-project_events']['sv-se'] = "Ta emot meddelanden om kommande Mphone-utbildningsklasser, kongressbås och andra evenemang relaterade till projektet.";
$text['description-project_events']['uk-ua'] = "Отримуйте сповіщення про майбутні навчальні курси Mphone, стенди для конференцій та інші події, пов’язані з проектом.";
$text['description-project_events']['tr-tr'] = "Yaklaşan Mphone eğitim sınıfları, kongre stantları ve projeyle ilgili diğer etkinlikler hakkında bildirimler alın.";
$text['description-project_events']['zh-cn'] = "接收即将举行的 Mphone 培训班、会议展位和其他与项目相关的活动的通知。";
$text['description-project_events']['ja-jp'] = "今後開催される Mphone トレーニング クラス、コンベンション ブース、およびプロジェクトに関連するその他のイベントの通知を受け取ります。";
$text['description-project_events']['ko-kr'] = "예정된 Mphone 교육 수업, 컨벤션 부스 및 프로젝트와 관련된 기타 이벤트에 대한 알림을 받습니다.";

$text['description-notifications']['en-us'] = "Set notification preferences for Mphone project-related communication and other local system alerts.";
$text['description-notifications']['vi-vn'] = "Thiết lập tùy chọn thông báo cho liên lạc liên quan đến dự án Mphone và các cảnh báo hệ thống cục bộ khác.";
$text['description-notifications']['en-gb'] = "Set notification preferences for Mphone project-related communication and other local system alerts.";
$text['description-notifications']['ar-eg'] = "تعيين تفضيلات الإعلام للاتصالات المتعلقة بمشروع Mphone وتنبيهات النظام المحلي الأخرى.";
$text['description-notifications']['de-at'] = "Legen Sie Benachrichtigungseinstellungen für die projektbezogene Mphone-Kommunikation und andere lokale Systemwarnungen fest.";
$text['description-notifications']['de-ch'] = "Legen Sie Benachrichtigungseinstellungen für die projektbezogene Mphone-Kommunikation und andere lokale Systemwarnungen fest.";
$text['description-notifications']['de-de'] = "Legen Sie Benachrichtigungseinstellungen für die projektbezogene Mphone-Kommunikation und andere lokale Systemwarnungen fest.";
$text['description-notifications']['el-gr'] = "Ορίστε τις προτιμήσεις ειδοποιήσεων για την επικοινωνία που σχετίζεται με το έργο Mphone και άλλες ειδοποιήσεις τοπικού συστήματος.";
$text['description-notifications']['es-cl'] = "Configure las preferencias de notificación para la comunicación relacionada con el proyecto Mphone y otras alertas del sistema local.";
$text['description-notifications']['es-mx'] = "Configure las preferencias de notificación para la comunicación relacionada con el proyecto Mphone y otras alertas del sistema local.";
$text['description-notifications']['fr-ca'] = "Définissez les préférences de notification pour les communications liées au projet Mphone et les autres alertes du système local.";
$text['description-notifications']['fr-fr'] = "Définissez les préférences de notification pour les communications liées au projet Mphone et les autres alertes du système local.";
$text['description-notifications']['he-il'] = "הגדר העדפות התראות עבור תקשורת הקשורה לפרויקט Mphone והתראות מערכת מקומית אחרות.";
$text['description-notifications']['it-it'] = "Imposta le preferenze di notifica per la comunicazione relativa al progetto Mphone e altri avvisi di sistema locale.";
$text['description-notifications']['ka-ge'] = "დააყენეთ გაფრთხილების პარამეტრები Mphone-ის პროექტთან დაკავშირებული კომუნიკაციისა და სხვა ლოკალური სისტემურ განგაშების მისაღებად.";
$text['description-notifications']['nl-nl'] = "Stel meldingsvoorkeuren in voor Mphone-projectgerelateerde communicatie en andere lokale systeemwaarschuwingen.";
$text['description-notifications']['pl-pl'] = "Ustaw preferencje powiadomień dla komunikacji związanej z projektem Mphone i innych lokalnych alertów systemowych.";
$text['description-notifications']['pt-br'] = "Defina as preferências de notificação para comunicação relacionada ao projeto Mphone e outros alertas do sistema local.";
$text['description-notifications']['pt-pt'] = "Defina as preferências de notificação para comunicação relacionada ao projeto Mphone e outros alertas do sistema local.";
$text['description-notifications']['ro-ro'] = "Setați preferințele de notificare pentru comunicarea legată de proiect Mphone și alte alerte de sistem local.";
$text['description-notifications']['ru-ru'] = "Установите настройки уведомлений для связи, связанной с проектом Mphone, и других локальных системных предупреждений.";
$text['description-notifications']['sv-se'] = "Ange aviseringsinställningar för Mphone-projektrelaterad kommunikation och andra lokala systemvarningar.";
$text['description-notifications']['uk-ua'] = "Встановіть параметри сповіщень для зв’язку, пов’язаного з проектом Mphone, та інших сповіщень локальної системи.";
$text['description-notifications']['tr-tr'] = "Mphone projesiyle ilgili iletişim ve diğer yerel sistem uyarıları için bildirim tercihlerini ayarlayın.";
$text['description-notifications']['zh-cn'] = "为 Mphone 项目相关通信和其他本地系统警报设置通知首选项。";
$text['description-notifications']['ja-jp'] = "Mphone プロジェクト関連の通信およびその他のローカル システム アラートの通知設定を設定します。";
$text['description-notifications']['ko-kr'] = "Mphone 프로젝트 관련 통신 및 기타 로컬 시스템 경고에 대한 알림 기본 설정을 지정합니다.";
