...
//dashboard icon
	...
	echo "			<span style=\"background-color: ".(!empty($widget_number_background_color) ? $widget_number_background_color : '#007aff')."; color: ".(!empty($widget_number_text_color) ? $widget_number_text_color : '#ffffff')."; font-size: 10px; text-align: center; position: absolute; top: 28px; left: 24px; padding: 2px 7px 1px 7px; border-radius: 10px; white-space: nowrap;\">".$domain_count."</span>\n";
	echo "		</div>\n";
	echo "	</div>\n";
