...
{*//Public Sans is self hosted, the interface must not depend on an external font service *}
	<link rel='stylesheet' type='text/css' href='{$project_path}/themes/mantis/css/fonts.css?updated=202608190000'>
	<link rel='stylesheet' type='text/css' href='{$project_path}/themes/mantis/css.php?updated=202606090000'>
{*//Mantis tokens and surface, loaded after css.php so they restyle it *}
	<link rel='stylesheet' type='text/css' href='{$project_path}/themes/mantis/css/tokens.css?updated=202608190000'>
	<link rel='stylesheet' type='text/css' href='{$project_path}/themes/mantis/css/mantis.css?updated=202608190000'>
			...
			//side menu visibility toggle
				...
				function menu_side_apply_layout(animate) {
					...
					if (is_mobile) {
						...
						content_width = window_width - contracted_width;
					}
					else {
					...
					if (animate) {
						...
						jQuery("#menu_side_container").stop(true, true).width(menu_width);
						jQuery("#content_container").stop(true, true).width(content_width);
					}
				}
				...
				function menu_side_item_toggle(item_id) {
					var submenu = $('#sub_'+item_id);
					var submenu_opening = submenu.is(':hidden');
					if (submenu_opening) {
						submenu.find('.menu_side_child').stop(true, true).show();
						submenu.find('[id^="menu_side_child_arrow_"]').removeClass('fa-chevron-right').addClass('fa-chevron-down');
					}
					...
					submenu.slideToggle(180, function() {
						{/literal}
