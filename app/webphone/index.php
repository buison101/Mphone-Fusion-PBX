...
*/
	...
	if ($request_path === '/app/webphone/index.php') {
		$query_string = $_SERVER['QUERY_STRING'] ?? '';
		header('Location: /app/webphone/'.($query_string !== '' ? '?'.$query_string : ''), true, 301);
		exit;
	}
	...
	if (!$client_mode) {
		...
		$client_url = '/app/webphone/?client=1';
	...
	$asset_path = '/app/webphone/assets/';
