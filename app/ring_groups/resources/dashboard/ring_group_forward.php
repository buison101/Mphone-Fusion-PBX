...
//doughnut chart
	if (empty($widget_chart_type) ||$widget_chart_type == "doughnut") {
		echo "	<div class='hud_chart' style='width: 90%;'><canvas id='ring_group_forward_chart'></canvas></div>\n";
		...
		echo "						'".($settings->get('theme', 'dashboard_ring_group_forward_chart_color_active') ?? '#d1d1d6')."',\n";
		echo "						'".($settings->get('theme', 'dashboard_ring_group_forward_chart_color_forwarding') ?? '#ff3b30')."'\n";
		echo "					],\n";
