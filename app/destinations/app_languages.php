...
$text['title-destinations']['vi-vn'] = 'Đích đến';
...
$text['title-destination-edit']['vi-vn'] = 'Đích đến';
...
$text['title-destination-add']['vi-vn'] = 'Đích đến';
...
$text['title-destination_import']['vi-vn'] = 'Nhập đích đến';
...
$text['title-destination_export']['vi-vn'] = 'Xuất đích đến';
...
$text['title-destination_summary']['vi-vn'] = 'Tóm tắt đích đến';
...
$text['title-destination_map']['vi-vn'] = 'Bản đồ đích đến';
...
$text['message-maximum_destinations']['vi-vn'] = 'Số đích đến tối đa:';
...
$text['label-alternate_destination']['vi-vn'] = 'Đích đến thay thế';
...
$text['header-destinations']['vi-vn'] = 'Đích đến';
...
$text['header-destination-edit']['vi-vn'] = 'Đích đến';
...
$text['header-destination-add']['vi-vn'] = 'Đích đến';
...
$text['header-destination_import']['vi-vn'] = 'Nhập đích đến';
...
$text['header-destination_export']['vi-vn'] = 'Xuất đích đến';
...
$text['description-monthly_price_buy']['vi-vn'] = 'Nhập giá hàng tháng bạn trả cho đích đến này (chỉ khi là gọi vào).';
...
$text['description-monthly_price']['vi-vn'] = 'Nhập giá hàng tháng để tính phí cho đích đến này (chỉ khi là gọi vào).';
...
$text['description-fax_uuid']['vi-vn'] = 'Chọn đích đến fax để bật phát hiện fax. ';
...
$text['description-providers']['vi-vn'] = 'Gán đích đến này cho một nhà cung cấp.';
...
$text['description-user']['vi-vn'] = 'Gán đích đến này cho một người dùng.';
...
$text['description-destinations']['vi-vn'] = 'Đích đến cuộc gọi vào là DID/DDI, DNIS hoặc Alias cho cuộc gọi vào.';
...
$text['description-destination_map']['vi-vn'] = 'Bản đồ đích đến là danh sách tất cả đích đến đã định nghĩa như máy nhánh, thư thoại, nhóm chuông, menu IVR, phòng hội nghị và nhiều mục khác.';
...
$text['description-destination_number']['vi-vn'] = 'Nhập đích đến.';
...
$text['description-destination_enabled']['vi-vn'] = 'Đặt trạng thái hiện tại của đích đến này.';
...
$text['description-destination_description']['vi-vn'] = 'Nhập mô tả cho đích đến này (tùy chọn).';
...
$text['description-group']['vi-vn'] = 'Gán đích đến cho một nhóm.';
...
$text['description-destination_ringback']['vi-vn'] = 'Xác định âm thanh người gọi sẽ nghe trong khi đích đến đang được gọi.';
...
$text['description-usage']['vi-vn'] = 'Đặt cách sử dụng đích đến này.';
...
$text['billing-warning']['en-us'] = "If you are using Mphone billing application, make sure to add accountcode and carrier variables.";
$text['billing-warning']['vi-vn'] = 'Nếu bạn dùng ứng dụng billing của Mphone, hãy đảm bảo thêm biến accountcode và carrier.';
$text['billing-warning']['en-gb'] = "If you are using Mphone billing application, make sure to add accountcode and carrier variables.";
...
$text['billing-warning']['el-gr'] = "Εάν χρησιμοποιείτε την εφαρμογή χρέωσης Mphone, φροντίστε να προσθέσετε μεταβλητές κωδικού λογαριασμού και εταιρείας κινητής τηλεφωνίας.";
$text['billing-warning']['es-cl'] = "Si está utilizando la aplicación de facturación Mphone, asegúrese de agregar lasvariables accountcode y carrier";
$text['billing-warning']['es-mx'] = "Si está utilizando la aplicación de facturación Mphone, asegúrese de agregar lasvariables accountcode y carrier";
$text['billing-warning']['fr-ca'] = "Si vous utilisez l'application de facturation Mphone, assurez-vous d'ajouter des variables de accountcode et carrier";
$text['billing-warning']['fr-fr'] = "Si vous utilisez l'application de facturation Mphone, assurez-vous d'ajouter des variables de accountcode et carrier";
$text['billing-warning']['he-il'] = "אם אתה משתמש Mphone חיוב יישום, הקפד להוסיף קוד חשבון ומשתנה נושא.";
$text['billing-warning']['it-it'] = "Se si usa l'applicazione per la fatturazione di Mphone, accertarsi di valorizzare accountcode e carrier.";
$text['billing-warning']['ka-ge'] = "თუ იყენებთ Mphone-ის ბილინგის აპლიკაციას, დარწმუნდით, რომ დააყენეთ ცვლადები accountcode და carrier.";
$text['billing-warning']['nl-nl'] = "Als je Mphone doorbelastingen applicatie gebruikt, zorg dan dat account code en Telco variabelen in gevuld zijn.";
...
$text['billing-warning']['pt-pt'] = "Se você estiver usando o aplicativo de faturamento Mphone, certifique-se de adicionar variáveis accountcode e carrier";
$text['billing-warning']['ro-ro'] = "Dacă utilizați aplicația de facturare Mphone, asigurați-vă că adăugați codul de cont și variabilele operatorului.";
$text['billing-warning']['ru-ru'] = "Если вы используете приложение биллинга Mphone, обязательно добавьте код учетной записи и переменные-несущие.";
$text['billing-warning']['sv-se'] = "Om du använder Mphone fakturering program, se till att lägga till 'account code' och operatör variabler";
$text['billing-warning']['uk-ua'] = "Якщо ви користуєтеся додатком для тарифікації в Mphone, то переконайтеся, щоб додано змінні код облікового запису і оператора. ";
...
$text['billing-warning']['zh-cn'] = "如果您使用的是 Mphone 计费应用程序，请确保添加帐户代码和运营商变量。";
$text['billing-warning']['ja-jp'] = "Mphone 請求アプリケーションを使用している場合は、必ずアカウントコードとキャリア変数を追加してください。";
$text['billing-warning']['ko-kr'] = "Mphone 결제 애플리케이션을 사용하는 경우 계정 코드 및 이동통신사 변수를 추가해야 합니다.";
