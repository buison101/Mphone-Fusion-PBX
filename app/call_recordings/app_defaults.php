...
if ($domains_processed == 1) {
	...
	$array['email_templates'][$x]['template_body'] .= "	 		border-color: #DCFCE7;\n";
	$array['email_templates'][$x]['template_body'] .= "	 		background: #F0FDF4;\n";
	...
	$array['email_templates'][$x]['template_body'] .= "	 		border-color: #DCFCE7;\n";
	$array['email_templates'][$x]['template_body'] .= "	 		background: #F0FDF4;\n";
	$array['email_templates'][$x]['template_body'] .= "	 		background: linear-gradient(180deg, #DCFCE7 0%, #F0FDF4 15px);\n";
	$array['email_templates'][$x]['template_body'] .= "	 		color: #000000;\n";
	$array['email_templates'][$x]['template_body'] .= "	 		}\n";
	$array['email_templates'][$x]['template_body'] .= "	\n";
	$array['email_templates'][$x]['template_body'] .= "	 	.message-bubble-me {\n";
	$array['email_templates'][$x]['template_body'] .= "	 		border-color: #CFFAFE;\n";
	$array['email_templates'][$x]['template_body'] .= "	 		background: #ECFEFF;\n";
	$array['email_templates'][$x]['template_body'] .= "	 		background: linear-gradient(180deg, #ECFEFF calc(100% - 15px), #CFFAFE 100%);\n";
	$array['email_templates'][$x]['template_body'] .= "	 		color: #000000;\n";
	$array['email_templates'][$x]['template_body'] .= "	 		}\n";
	$array['email_templates'][$x]['template_body'] .= "	 </style>\n";
	$array['email_templates'][$x]['template_body'] .= "	</head>\n";
