...
$array['dashboard_widgets'][$x]['widget_icon_color'] = '#aabbe8';
...
$array['dashboard_widgets'][$x]['widget_label_text_color'] = '#1b1f3b';
...
$array['dashboard_widgets'][$x]['widget_number_background_color'] = '#4e2fa1';
