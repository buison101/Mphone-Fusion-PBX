...
$text['billing-warning']['it-it'] = "Se si utilizza l'applicazione di fatturazione Mphone, assicurarsi di aggiungere codice account e variabili di vettore.";
$text['billing-warning']['ka-ge'] = "თუ იყენებთ Mphone-ის ბილინგის აპლიკაციას, დარწმუნდით, რომ დაამატეთ ცვლადები accountcode და carrier.";
$text['billing-warning']['nl-nl'] = "Als je de Mphone rekening toepassing gebruikt, zorg dan dat een account code en telco variabele toegevoegd is.";
...
$text['billing-warning']['tr-tr'] = "Eğer Mphone faturalama uygulamasını kullanıyorsanız accountcode ve carrier değişkenlerini eklediğinizden emin olun.";
