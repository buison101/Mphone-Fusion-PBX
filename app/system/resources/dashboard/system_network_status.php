...
//if ($dashboard_chart_type === 'line') { ?>
	...
	<script>
		...
		const dashboard_network_usage_chart_main_color = [
			'<?php echo($settings->get('theme', 'dashboard_network_usage_chart_main_color', [0 => '#34c759'])[0]); ?>',  // green default
			'<?php echo($settings->get('theme', 'dashboard_network_usage_chart_main_color', [1 => '#ff9500'])[1]); ?>'   // orange default
		];
