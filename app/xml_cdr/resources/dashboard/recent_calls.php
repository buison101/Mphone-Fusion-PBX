				...
				document.getElementById('recent_calls_chart').getContext('2d'),
				{
					...
					data: {
						datasets: [{
							...
							backgroundColor: [
								'<?php echo ($settings->get('theme', 'dashboard_recent_calls_chart_main_color') ?? '#4F7FE2'); ?>',
								'<?php echo ($settings->get('theme', 'dashboard_recent_calls_chart_sub_color') ?? '#DCE3EC'); ?>'
							],
