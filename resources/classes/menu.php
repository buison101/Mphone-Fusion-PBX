...
class menu {
	...
	public function menu_horizontal($menu_array) {
		...
		if ($menu_brand) {
			...
			$menu_brand_text = escape($this->settings->get('theme', 'menu_brand_text', 'Mphone'));
	...
	public function menu_vertical($menu_array) {
		...
		$body_header_brand_text = escape($this->settings->get('theme', 'body_header_brand_text', 'Mphone'));
