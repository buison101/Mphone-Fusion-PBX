	...
	//theme settings
		if (is_array($_SESSION['theme']) && @sizeof($_SESSION['theme']) != 0) {
			...
			//pre-process some settings
				if (empty($settings_array['theme']['custom_css'])) {
					$settings_array['theme']['custom_css'] = $settings->get('theme', 'custom_css');
				}
				...
				$settings_array['theme']['footer'] = isset($settings_array['theme']['footer']) ? $settings_array['theme']['footer'] : '&copy; '.$text['theme-label-copyright'].' 2008 - '.date('Y')." <a href='https://mphone.vn' class='footer' target='_blank'>mphone.vn</a> ".$text['theme-label-all_rights_reserved'];
