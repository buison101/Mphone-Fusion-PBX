...
Flickable {
    ...
    readonly property int status: SettingsState.clioAuthStatus
    ...
    Rectangle {
        ...
        Rectangle {
            ...
            SettingsGroupBox {
                ...
                title: qsTrId("settings_clio") + Translator.translate;
                ...
                Label {
                    ...
                    text: qsTrId("settings_integration_clio_description").arg(StringStorage.appTitle) + Translator.translate
                ...
                SettingsTextField {
                    ...
                    width: 120
                    property string crmServer: SettingsState.clioAccount.server

                    text: crmServer

                    onTextChanged: {
                        if (text != crmServer) {
                            ActionProvider.markCrmAccountUpdate(CrmType.Clio, CrmAccount.Server, text);
                        }
                    }
                ...
                SettingsButton {
                    ...
                    onClicked: {
                        ActionProvider.tryAuthorizeClioAccount();
                        if(isOpenUrl) {
                            Qt.openUrlExternally(SettingsState.clioAuthLink)
                        }
                    }
                }
            }
