...
Flickable {
    ...
    property int treeContentWidth: 300

    property bool alternatingRowColors: true

    property color backgroundColor: ColorStorage.settingsWindowBaseColor
    ...
    property Component rowDelegate: Rectangle {
        ...
        property color selectedColor: "#07c"
    ...
    ListView {
        ...
        Component {
            ...
            FocusScope {
                ...
                readonly property color itemTextColor: "black"
    ...
    __itemDelegateLoader: Loader {
            ...
            Loader {
                ...
                sourceComponent: Image {
                        ...
                        source: styleData.isExpanded ? "qrc:/images/icon_treeview_expanded.svg" : "qrc:/images/icon_treeview_collapsed.svg"
                    }
    ...
    __mouseArea: MouseArea {
        ...
        Timer {
            running: mouseArea.autoScroll !== 0
            interval: 20
            repeat: true
            onTriggered: {
